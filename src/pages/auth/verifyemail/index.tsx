    ...
    return (
        <AuthLayout image="/images/3.png" > 
            <Box width="400px" > 
                ...
                <Box gap="16px" display="flex" flexDirection="column"  marginTop="20px" >
                    <InputComponent left={true} type="number" leftIcon={<Icon icon="shield" />} placeholder="00000" />
                </Box>
                <Box width="full" display="flex" flexDirection="column"  marginTop="30px" >  
                    <Button onClick={()=> Router.push("/auth/setupaccount")} as={motion.button} whileHover={{ scale: 1.05 }}  _hover={{ bg: "brand.primaryColor" }} fontFamily="body" marginTop="16px" fontSize="16px" fontWeight="700" width="full" color="white" bgColor="brand.primaryColor" height="60px" >Continue</Button>
                </Box> 
