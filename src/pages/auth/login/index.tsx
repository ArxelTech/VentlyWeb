        ...
        <AuthLayout image="/images/1.png" >
            <Box width="400px" > 
                ...
                <Box gap="16px" display="flex" flexDirection="column"  marginTop="30px" >
                    ...
                    <InputComponent left={true} type="password" leftIcon={<Icon icon="lock" />} placeholder="Password"  />
                </Box>
                <Box width="full" display="flex" flexDirection="column"  marginTop="30px" > 
                    ...
                    <Button as={motion.button} whileHover={{ scale: 1.05 }}  _hover={{ bg: "brand.primaryColor" }} fontFamily="body" marginTop="16px" fontSize="15px" fontWeight="700" width="full" color="white" bgColor="brand.primaryColor" height="60px" >LOG IN</Button>
                </Box> 
