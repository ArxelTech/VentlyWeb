import { Box, chakra, Container, Flex, Image, shouldForwardProp } from '@chakra-ui/react' 
...
export default function AuthLayout({children, image}: Props) {
    ...
    return (
        <Flex  alignItems="center" height="100vh" overflow="hidden" >
            <ChakraBox 
